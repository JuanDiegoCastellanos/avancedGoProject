...
// Source: github.com/JuanDiegoCastellanos/advancedGoProject/db/sqlc (interfaces: Store)
//
// Generated by this command:
//
//	mockgen --destination db/mock/store.go github.com/JuanDiegoCastellanos/advancedGoProject/db/sqlc Store
//
